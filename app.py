...
import pomodoro_feature3 as f3
...
# 음악 파일 업로드
uploaded_file = st.sidebar.file_uploader("🎵 Upload music(.mp3)", type=["mp3"])
music_base64 = f1.encode_music_file(uploaded_file)

if music_base64:
    st.audio(data=base64.b64decode(music_base64), start_time=0)
# 세션 상태 초기화 및 로딩
